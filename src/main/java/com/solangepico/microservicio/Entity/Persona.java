...
public class Persona {
	...
	public Persona(String nombre_persona, int edad_persona, String identificacion_persona, String direccion_persona,
			String telefono_persona, String genero_persona) {
		super();
